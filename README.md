...
추가로 해당 그래프를 만들기 위해 제작한 프로그램은 터미널 오버헤드를 발생시키지 않으므로 훨신 빠른 시간 안에 실행된다.
해당 실험결과에서 가장 빠른 속도는 56$278 &micro;s$이다
```
...
N의 값은 10만개 - 100만개, Thread의 개수는 1-99개로 설정했고 맥, 리눅스 환경에서 각각 10번씩 실행한 결과의 평균값이다.
